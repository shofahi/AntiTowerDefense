...
public class SpecialAttacker extends Attacker {
    static private final int SPEED = 25;            //Default speed for Special
    static private final int START_HEALTH = 175;    //Default health for Special
    ...
    public void render(Graphics g){
        g.drawImage(specialAttackerImg,getPos().getX(),getPos().getY(),getWidth(),getHeight(),null);
